    ...
    const fetchDashboardData = async () => {
      try {
        ...
        setDashboardData({
          ...
          recentLabResults: labRequestsResponse.data
          ...
          <Col xs={24} sm={12} md={6}>
            <Card>
              <Statistic
                ...
                value={
                  dashboardData.recentPrescriptions.filter(
                    (p) => p.status === "pending"
                  ).length
                }
                  ...
                  {dashboardData.recentLabResults.length > 0 ? (
                    <List
                      ...
                      renderItem={(item) => (
                        <List.Item>
                          <List.Item.Meta
                            title={<Text>Test Request #{item.id}</Text>}
                            description={
                              <Space direction="vertical">
                                <Text>
                      ...
                      <List.Item.Meta
                        title={
                          <Space>
                            ...
                            <Tag color="red">
                              Due: {moment(item.due_date).format("MMM D")}
                            </Tag>
                          </Space>
                        }
                        description={
